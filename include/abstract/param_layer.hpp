...
#ifndef DL_SOURCE_LAYER_PARAM_LAYER_HPP_
#define DL_SOURCE_LAYER_PARAM_LAYER_HPP_
#include "layer.hpp"
...
class ParamLayer : public Layer<float>
{
   public:
     ...
     */
    void InitWeightParam(uint32_t param_count, uint32_t param_channel, uint32_t param_height, uint32_t param_width);
     ...
     */
    void InitBiasParam(uint32_t param_count, uint32_t param_channel, uint32_t param_height, uint32_t param_width);
